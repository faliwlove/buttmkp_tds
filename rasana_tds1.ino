...
void readTDS()
{
  ...
  if (millis() - analogSampleTimepoint > 40U)
  {
    ...
    if (analogBufferIndex == SCOUNT)
      analogBufferIndex = 0; // membaca data sebanyak 30 kali
  }
...
void loop()
{
  ...
  http.begin(client, "http://e-farmingcorpora.com/buttmkp/eco_office/getdata_tds.php");
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");
  int httpCode = http.POST(postData);

  http.begin(client, "http://e-farmingcorpora.com/buttmkp/eco_office/getdata_wt.php");
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");
